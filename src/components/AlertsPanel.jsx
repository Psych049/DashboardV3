    ...
    <div className="bg-white p-6 rounded-lg shadow-sm">
      ...
      {alerts.length === 0 ? (
        <div className="text-center py-6">
          <svg className="h-12 w-12 text-gray-300 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li key={index} className={`${getBadgeColor(alert.type)} rounded-lg p-4 flex items-start`}>
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-xs text-gray-500">{alert.timeAgo}</div>
                </div>
